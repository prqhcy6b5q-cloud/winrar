...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "RustDesk പാസ്‌വേഡ് പരിശോധിക്കുക"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "സെർവർ പ്രോ {} ലേക്ക് അപ്‌ഗ്രേഡ് ചെയ്യുക"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "റിമോട്ട് പതിപ്പ് {} ലേക്ക് മാറ്റുക"),
