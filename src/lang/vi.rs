...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "Xác thực mật khẩu RustDesk"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
