...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "رمز عبور RustDesk را تأیید کنید"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید RustDesk Server Pro لظفا"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "لطفاً RustDesk را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
