...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "אמת סיסמת RustDesk"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "אנא שדרג את RustDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "אנא שדרג את לקוח RustDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
