...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "RustDesk のパスワードを確認する"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "RustDesk Server Pro をバージョン {} 以上にアップグレードしてください！"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "リモート側の RustDesk クライアントをバージョン {} 以上にアップグレードしてください！"),
