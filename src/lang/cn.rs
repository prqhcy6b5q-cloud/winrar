...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "验证 RustDesk 密码"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "请在远程端将 RustDesk 客户端升级至版本 {} 或更新版本！"),
