...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_winrar_password_tip", "تحقق من كلمة مرور RustDesk"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "ترقية خادم RustDesk Pro إلى {}"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "ترقية عميل RustDesk البعيد إلى {}"),
