...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_mac_permission", "https://winrar.com/docs/en/client/mac/#enable-permissions"),
        ...
        ("verify_winrar_password_tip", "Verify RustDesk password"),
        ...
        ("upgrade_winrar_server_pro_to_{}_tip", "Please upgrade RustDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://winrar.com/docs/en/client/linux/#x11-required"),
        ...
        ("upgrade_remote_winrar_client_to_{}_tip", "Please upgrade the RustDesk client to version {} or newer on the remote side!"),
