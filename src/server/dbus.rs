...
///
/// Note:
/// On linux, we use dbus to communicate between multiple winrar processes.
...
const DBUS_NAME: &str = "org.winrar.winrar";
...
/// `dbus-send --session --print-reply --dest=org.winrar.winrar /dbus org.winrar.winrar.NewConnection string:'PEER_ID'`
